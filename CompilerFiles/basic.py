...
class Parser:
    ...
    def atom(self):
        ...
        elif tok.matches(TT_KEYWORD, KEYWORDS['FUN']):
...
global_symbol_table.set(BUILTIN["NULL"], Number.null)
global_symbol_table.set(BUILTIN["FALSE"], Number.false)
global_symbol_table.set(BUILTIN["TRUE"], Number.true)
global_symbol_table.set(BUILTIN["MATH_PI"], Number.math_PI)
global_symbol_table.set(BUILTIN["PRINT"], BuiltInFunction.print)
global_symbol_table.set(BUILTIN["PRINT_RET"], BuiltInFunction.print_ret)
global_symbol_table.set(BUILTIN["INPUT"], BuiltInFunction.input)
global_symbol_table.set(BUILTIN["INPUT_INT"], BuiltInFunction.input_int)
global_symbol_table.set(BUILTIN["CLEAR"], BuiltInFunction.clear)
global_symbol_table.set(BUILTIN["CLS"], BuiltInFunction.clear)
global_symbol_table.set(BUILTIN["IS_NUM"], BuiltInFunction.is_number)
global_symbol_table.set(BUILTIN["IS_STR"], BuiltInFunction.is_string)
global_symbol_table.set(BUILTIN["IS_LIST"], BuiltInFunction.is_list)
global_symbol_table.set(BUILTIN["IS_FUN"], BuiltInFunction.is_function)
global_symbol_table.set(BUILTIN["APPEND"], BuiltInFunction.append)
global_symbol_table.set(BUILTIN["POP"], BuiltInFunction.pop)
global_symbol_table.set(BUILTIN["EXTEND"], BuiltInFunction.extend)
global_symbol_table.set(BUILTIN["LEN"], BuiltInFunction.len)
global_symbol_table.set(BUILTIN["RUN"], BuiltInFunction.run)
